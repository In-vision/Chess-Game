...
public class Pawn extends Piece {
	...
	protected MoveList[] getPieceMoves() {
		 ...
		 * correct direction and two-space movement. All the board-dependent things
		 * (like diagonal iff capturing) are ChessBoard's job.
		 */
		...
		// since pawns will never be white AND black, only returns moves of correct
		// direction
		if (isWhite) {
